...
import { Chrome, Sparkles, ArrowLeft, Mail, Lock, User } from "lucide-react"
        ...
        <div className="min-h-screen bg-background flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md">
                ...
                >
                    ...
                    {/* Email/Password Form */}
                    <form action={isSignUp ? signUpWithEmail : loginWithEmail} className="space-y-4 mb-6">
                        {isSignUp && (
                            <div>
                    ...
                    <form action={loginWithGoogle}>
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            type="submit"
                            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-zinc-50 text-zinc-900 border border-zinc-200 rounded-xl px-6 py-3 font-medium transition-all duration-200 shadow-sm hover:shadow-md"
                        >
