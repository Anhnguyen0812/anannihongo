...
// Basic Hiragana (Gojūon - 46 basic characters)
export const HIRAGANA_BASIC: KanaChar[][] = [
    [
...
// Hiragana Handakuon (Half-voiced)
...
// Hiragana Yōon (Combination sounds)
...
// Basic Katakana (Gojūon - 46 basic characters)
export const KATAKANA_BASIC: KanaChar[][] = [
    [
...
// Katakana Handakuon (Half-voiced)
...
// Katakana Yōon (Combination sounds)
...
export const HIRAGANA_ROWS = HIRAGANA_BASIC;
export const KATAKANA_ROWS = KATAKANA_BASIC;
